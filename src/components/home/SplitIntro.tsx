...
const cards = [
  {
    ...
    titleAccent: "for your product.",
    body: "Web apps, SaaS platforms, ecommerce stores, and internal tools — scoped to ship cleanly and hand off without friction.",
    href: "/services",
  ...
  },
  {
    ...
    title: "Work that",
    titleAccent: "shipped.",
    body: "Real client builds in production — inspection SaaS, ecommerce stores, dashboards, and platforms teams run every day.",
    href: "/case-studies",
  ...
  },
  {
    ...
    title: "My own",
    titleAccent: "product.",
    body: "SoldTools — a live product for car sales teams. Built on my own time, separate from client work.",
    href: "/studio",
    cta: "Open Studio",
    initial: "T",
  },
